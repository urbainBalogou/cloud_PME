(()=>{(function(){"use strict";let n=function t(c){return $("[data-loading-icon]").each(function(){let e=$(this).data("color")!==void 0?$(this).data("color"):$("body").css("color"),i=$(this).attr("class")!==void 0?$(this).attr("class"):"",l=[{name:"audio",svg:`
                ...
                `}],a=this;l.forEach(function(r){$(a).data("loading-icon")==r.name&&$(a).replaceWith(r.svg)})}),t}();(function(){window.tailwind===void 0&&(window.tailwind={}),window.tailwind.svgLoader=function(){n()}})()})();})();
